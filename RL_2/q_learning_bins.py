...
#turn list of integers in an int
#i.e [1,2,3,4,5] --> 12345
...
class FeatureTransformer:
    def __init__(self):
        ...
        self.car_velocity_bins = np.linspace(-2, 2, 9) # (-inf,-inf) didnt check these are good values
        self.pole_angle_bins = np.linspace(-0.4, 0.4, 9)
        self.pole_velocity_bins = np.linspace(-3.5, 3.5, 9) # (-inf,-inf) didnt check these are good values
